...
export async function activate(context: vscode.ExtensionContext) {
	...
	const diagnosticCollection = vscode.languages.createDiagnosticCollection('types-installer-helper');
	...
	// Push all of the disposables that shoudl be cleaned up when the extension is disabled
